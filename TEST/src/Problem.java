...
public class Problem {
	...
	public void initializearray(CheckerPiece array[][]) {
		...
		array[2][3]= new CheckerPiece (false,"C3", startingplayer);
		array[2][1]=new CheckerPiece (false,"C1", startingplayer );
	...
	public void Random() {
		...
		while(!endstate) {
			switch(move) {
			case 0: if(Game.user.color=="w"){UserTurn();}else{ComputerTurn();}move = 1; 
			case 1: if(Game.user.color=="b"){UserTurn();}else{ComputerTurn();}move = 0;  
			}	
		}*/
	}
	...
	public void UserTurn() {
		...
		Action Actionmade = new Action(startrow,startcol,destrow,destcol,Game.user.color);
